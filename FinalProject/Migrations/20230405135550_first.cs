        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Published = table.Column<bool>(type: "bit", nullable: false),
                    UrlLink = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "AttribustesPrices",
                columns: table => new
                {
                    AttribustesPriceID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttribustesPrices", x => x.AttribustesPriceID);
                    table.ForeignKey(
                        name: "FK_AttribustesPrices_Attributes",
                        column: x => x.AttributeID,
                        principalTable: "Attributes",
                        principalColumn: "AttributeID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AttribustesPrices_Products",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttribustesPrices_AttributeID",
                table: "AttribustesPrices",
                column: "AttributeID");

            migrationBuilder.CreateIndex(
                name: "IX_AttribustesPrices_ProductID",
                table: "AttribustesPrices",
                column: "ProductID");
